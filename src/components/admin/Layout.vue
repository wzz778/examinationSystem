  ...
  <div id="layout">
    <div id="nav" class="nav1">
        ...
        <el-submenu index="4">
            ...
            <el-menu-item index="/admin/subjectlist">学科列表</el-menu-item>
            <el-menu-item index="4-2">学科创编</el-menu-item>
        </el-submenu>
    ...
    <div id="head" :class="rehead">
        <div class="headtop">
            <button type="button" id="sidebarCollapse" class="sidebar_toggle" @click="isCollapse=!isCollapse"><i :class="refold"></i></button>
